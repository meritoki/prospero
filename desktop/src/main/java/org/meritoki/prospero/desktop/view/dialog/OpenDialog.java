...
public class OpenDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				...
				layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(openFileChooser,
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(OpenDialog.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);

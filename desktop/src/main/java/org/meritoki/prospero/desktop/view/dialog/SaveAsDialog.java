...
public class SaveAsDialog extends javax.swing.JDialog {
	...
	public SaveAsDialog(java.awt.Frame parent, boolean flag, Model model) {
		...
		if(this.model.system.file != null) {
			this.saveFileChooser.setSelectedFile(this.model.system.file);
		} else {
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				...
				layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(saveFileChooser,
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SaveAsDialog.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);

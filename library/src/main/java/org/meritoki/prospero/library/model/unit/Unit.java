...
public class Unit {
	...
	public static double LIGHT_SPEED = 299792458;//Meters/Second
	...
	public static double ELECTRON_RADIUS = (2.8179403227e-15);//Meters
	public static double ELECTRON_MASS = 9.10938356e-31;//Kilograms
